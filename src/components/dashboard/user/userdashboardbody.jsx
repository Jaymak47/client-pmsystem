  ...
  return (
    <div>
      <Row className="m-2 ">
        ...
        <CardGroup>
          <Card className="m-2">
            <Link style={{ textDecoration: "none" }} to="/userprojects">
          ...
          <Card className="m-2">
            <Link style={{ textDecoration: "none" }} to="/usercontracts">
              <Card.Img variant="top" src={Projects} />

              <Card.Body>
                <Card.Title>Performance Contracts</Card.Title>
                <Card.Text>
                  A collection of All County Contracts by their Departments,
                  Sections, Areas of Implementation
                </Card.Text>
                <Card.Text>
                  <strong>Total Contracts ----{projects.length}</strong>
                </Card.Text>
              </Card.Body>
          ...
          <Card className="m-2">
            <Link style={{ textDecoration: "none" }} to="/useractivities">
        ...
        <CardGroup>
          ...
          <Card className="m-2">
            <Link style={{ textDecoration: "none" }} to="/targets">
              ...
              <Card.Body>
                <Card.Title>My Targets</Card.Title>
                <Card.Text>
          ...
          <Card>
            <Link style={{ textDecoration: "none" }} to="/selfappraisal">
              ...
              <Card.Body>
                <Card.Title>My Appraisal</Card.Title>
                <Card.Text>
                  Performance Appraisal Setting, View Targets, Agreed Perfomance
                  Targets, Perfomance Indicators, Performnce Evaluation, Score
                  Rating
                </Card.Text>
              </Card.Body>
              <Card.Footer>
          ...
          <Card>
            <Link style={{ textDecoration: "none" }} to="/trainings">
              ...
              <Card.Body>
                ...
                <Card.Text>
                  A Listing of upcoming Departmental Trainings : Projects,
                  Activities, Tasks and Departments
                </Card.Text>
                <Card.Text>
