...
const AppraisalReviewMeeting = (props) => {
  ...
  const handleBack = () => {
    history.push("/jointmeetingappraisees");
  };
          ...
          <Col md="9">
            <Form noValidate validated={validated} onSubmit={onSubmit}>
              <Row className="m-5">
                ...
                <Row className=" mt-2 tablestlyles4">
                  <h3>
                    Appraisee: - -{firstname} {surname}
                    {"|"} Department {":"}
