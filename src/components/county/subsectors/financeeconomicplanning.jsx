...
import FinanceEconomicPlanningStrategies from "./strategicpriorities/financeeconomicplanning";
          ...
          <Col md="9">
            <Row>
              <Col className="sectiondescription">
                <div className="m-2">
                  <Row className="m-5">
                    <h1>
                      Finance, Economic Planning, ICT, Special Programme and
                      Conflict Resolution
                    </h1>
                  </Row>
                </div>
            ...
            <Row>
              <Col>
                ...
                <FinanceEconomicPlanningStrategies />
                <VisionBody />
              </Col>
              <Col lg="3">
                <DashBoardRsideMenu
