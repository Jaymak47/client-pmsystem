              ...
              <>
                ...
                >
                  <ListGroup.Item className="d-flex ">
                    ...
                    <Col>
                      <h4>View Departmental Projects</h4>
                    </Col>
                  </ListGroup.Item>
                </Link>
              </>
              <>
                ...
                >
                  <ListGroup.Item className="d-flex ">
                    ...
                    <Col>
                      <h4>View Departmental Contracts</h4>
                    </Col>
                  </ListGroup.Item>
                </Link>
              </>
              <>
                ...
                >
                  <ListGroup.Item className="d-flex ">
                    ...
                    <Col>
                      <h4>View Departmental Activities</h4>
                    </Col>
                  </ListGroup.Item>
                </Link>
              </>
              ...
              <>
                <Link style={{ textDecoration: "none" }} to="/targets">
                  <ListGroup.Item className="d-flex ">
                    ...
                    <Col>
                      <h4> Add {"&"} View Personal Targets</h4>
                    </Col>
                  </ListGroup.Item>
                </Link>
              </>
